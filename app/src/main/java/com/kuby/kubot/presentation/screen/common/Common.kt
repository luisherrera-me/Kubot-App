package com.kuby.kubot.presentation.screen.common
...
import com.kuby.kubot.util.Constants.CLIENT_ID
    ...
    val activityLauncher = rememberLauncherForActivityResult(
        ...
        try {
            if (result.resultCode == Activity.RESULT_OK){
                ...
                val tockenId = credentials.googleIdToken
                if (tockenId != null){
                    onResultReceived(tockenId)
                }
            }else{
